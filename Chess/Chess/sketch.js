...
var score=0;
var character;
//De peon a caballo 5 puntos, de caballo a alfil 15 puntos, de alfil a torre 25 puntos, de torre a dama 35 puntos y de dama a rey 45 puntos
...
function setup() {
  ...
  if(score<5){
    ...
    character.addImage("Rey", rey_B_Img);
  }
  character.scale = 0.3;
